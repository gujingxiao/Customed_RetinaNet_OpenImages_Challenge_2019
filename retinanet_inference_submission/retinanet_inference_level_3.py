...
if __name__ == '__main__':
    ...
    pretrained_model_path = 'retinanet_training_level_1/level3_model/resnet50_oid_map_level_3_04958.h5'
    output_cache_directory = '/media/gujingxiao/5a3e3730-4fda-48c0-9962-9998b9a1c116/OpenimageV5/cache_retinanet_level_3_{}/'.format(backbone)
    ...
    create_csv_for_retinanet(output_cache_directory, 'predictions_{}_{}_{}_level3.csv'.format(skip_box_confidence, iou_thr, type),
